...
if (isset($_POST['save'])) {
    ...
    $sql = "UPDATE complaints_student set
                victimFirstName = ?, 
                victimMiddleName = ?, 
                victimLastName = ?, 
                victimDOB = ?, 
...
if (isset($_POST['print'])) {
    ...
    header("Location: complaint_print_student.php?id=$complaint_id");
    exit();
}
...
<div id="main">
    ...
    <div class="container-fluid">
        <div class="container-fluid bg-white mt-2 rounded-lg border">
            <a href="complaint_student.php" class="btn btn-outline-danger float-left mt-3"><i class="fas fa-arrow-left"></i>
            </a>
            ...
            <form action="" method="post">
                ...
                <div class="container-fluid bg-white pt-2 pb-3 rounded-lg">
                    ...
                    <div class="form-row mt-3 pb-4">
                        <div class="col-md-3">
                            <strong>Grade:</strong>
                            <select class="form-control" name="complainedGrade">
                                <option value="11" <?php echo (isset($complaint_data['complainedGrade']) && $complaint_data['complainedGrade'] == '11') ? 'selected' : ''; ?>>11</option>
                                <option value="12" <?php echo (isset($complaint_data['complainedGrade']) && $complaint_data['complainedGrade'] == '12') ? 'selected' : ''; ?>>12</option>
                            </select>
                        </div>

                        <div class="col-md-3"><strong>Section:</strong>
                            <input type="text" class="form-control" name="complainedSection"
                                value="<?php echo htmlspecialchars($complaint_data['complainedSection'] ?? ''); ?>" required>
                        </div>
                        <div class="col-md-6"><strong>Adviser:</strong>
                            <input type="text" class="form-control" name="complainedAdviser"
                                value="<?php echo htmlspecialchars($complaint_data['complainedAdviser'] ?? ''); ?>" required>
                        </div>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <input type="text" class="form-control" name="complainedMotherName"
                                    value="<?php echo ucwords(htmlspecialchars($complaint_data['complainedMotherName'] ?? '')); ?>" required>
                            </div>
                            <div class="row mt-3">
                                <strong>Occupation:</strong>
                                <input type="text" class="form-control" name="complainedMotherOccupation"
                                    value="<?php echo ucwords(htmlspecialchars($complaint_data['complainedMotherOccupation'] ?? '')); ?>" required>
                            </div>
                            <div class="row mt-3">
                                <strong>Address:</strong>
                                <input type="text" class="form-control" name="complainedMotherAddress"
                                    value="<?php echo ucwords(htmlspecialchars($complaint_data['complainedMotherAddress'] ?? '')); ?>" required>
                            </div>
                            <div class="row mt-3">
                                <strong>Contact:</strong>
                                <input type="text" class="form-control" name="complainedMotherContact"
                                    value="<?php echo htmlspecialchars($complaint_data['complainedMotherContact'] ?? ''); ?>" required pattern="\d{11}"
                                    maxlength="11"
                                    oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 11);" />
                            </div>
                        </div>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <input type="text" class="form-control" name="complainedFatherName"
                                    value="<?php echo ucwords(htmlspecialchars($complaint_data['complainedFatherName'] ?? '')); ?>" required>
                            </div>
                            <div class="row mt-3">
                                <strong>Occupation:</strong>
                                <input type="text" class="form-control" name="complainedFatherOccupation"
                                    value="<?php echo ucwords(htmlspecialchars($complaint_data['complainedFatherOccupation'] ?? '')); ?>" required>
                            </div>
                            <div class="row mt-3">
                                <strong>Address:</strong>
                                <input type="text" class="form-control" name="complainedFatherAddress"
                                    value="<?php echo ucwords(htmlspecialchars($complaint_data['complainedFatherAddress'] ?? '')); ?>" required>
                            </div>
                            <div class="row mt-3">
                                <strong>Contact:</strong>
                                <input type="text" class="form-control" name="complainedFatherContact"
                                    value="<?php echo htmlspecialchars($complaint_data['complainedFatherContact'] ?? ''); ?>" required pattern="\d{11}"
                                    maxlength="11"
                                    oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 11);" />
                            </div>
                        </div>
