...
$student_first_name = isset($_POST['student_first_name']) ? $_POST['student_first_name'] : '';
$student_middle_name = isset($_POST['student_middle_name']) ? $_POST['student_middle_name'] : '';
$student_last_name = isset($_POST['student_last_name']) ? $_POST['student_last_name'] : '';
            ...
            <table class="table-form">
                ...
                <tr>
                    <td class="pt-5 pl-5 pr-5 certify-text">
                        This is to certify that <u><?php echo ucwords(htmlspecialchars($student_first_name) . ' ' . htmlspecialchars($student_middle_name) . ' ' . htmlspecialchars($student_last_name)); ?></u> is a bonafide student of <b>Nasugbu East Senior High School</b> during the School Year <u><?php echo htmlspecialchars($school_year); ?></u>.
                    </td>
