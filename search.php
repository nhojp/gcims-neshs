...
<div id="main">
    ...
    <div class="container-fluid mb-5">
        <div class="container-fluid bg-white mt-2 rounded-lg pb-2 border">
            <div class="row pt-3">
                <div class="col-md-1">
                    <button class="btn btn-danger" onclick="window.location.href='student.php'">
                    ...
                    <div class="modal-content shadow-lg rounded-3">
                        ...
                        <div class="modal-body text-center">
                            ...
                            <div class="d-flex justify-content-between">
                                <button type="button" class="btn btn-secondary w-100 mt-5" data-dismiss="modal">Cancel</button>
                                <form method="POST" action="" class="mb-0">
                                    <input type="hidden" name="delete_id" value="<?php echo htmlspecialchars($student['id']); ?>">
                                    <button type="submit" class="btn btn-danger w-100 mt-5">Delete</button>
                                </form>
                            </div>
                        </div>
                    </div>
