...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['edit_id'])) {
        ...
        if ($stmt->execute()) {
            // Success: Show success toast
            $toast_message = "Student edited successfully!";
            $toast_class = "success";
        } else {
            // Error: Show error toast
            $toast_message = "Something went wrong while editing the student.";
            $toast_class = "danger";
        }
    }
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" id="studentForm">
                    ...
                    <div class="form-group">
                        <input type="text" name="lrn" placeholder="Learner Reference Number (LRN)" required class="form-control">
                    </div>
                    <div class="form-group">
...
<script>
    ...
    function viewStudent(studentId) {
        ...
        window.location.href = 'student-profile.php?id=' + studentId; // Adjust the page URL as necessary
    }
